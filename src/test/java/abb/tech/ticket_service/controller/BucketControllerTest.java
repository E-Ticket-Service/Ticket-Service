...
//            lenient().when(bucketService.addItem(any())).thenReturn(itemResponse);
//
...
//            lenient().when(bucketService.addItem(any())).thenReturn(noSeatResp);
//
//            mockMvc.perform(post("/buckets/items")
//                            .contentType(MediaType.APPLICATION_JSON)
//                            .content(objectMapper.writeValueAsString(req)))
...
//            ReqBucketDto req = new ReqBucketDto(USER_ID, SESSION_ID, null, 1);
//            lenient().when(bucketService.addItem(any()))
...
//            lenient().when(bucketService.getBucketByUserId(USER_ID)).thenReturn(bucketResponse);
//
...
//            lenient().when(bucketService.getBucketByUserId(USER_ID))
...
//            lenient().when(bucketService.getBucketByUserId(USER_ID)).thenReturn(emptyBucket);
//
//            mockMvc.perform(get("/buckets").param("userId", String.valueOf(USER_ID)))
//                    .andExpect(status().isOk())
...
//            lenient().when(bucketService.getItemsByUserId(USER_ID)).thenReturn(List.of(itemResponse));
//
...
//            lenient().when(bucketService.getItemsByUserId(USER_ID)).thenReturn(List.of());
//
//            mockMvc.perform(get("/buckets/items").param("userId", String.valueOf(USER_ID)))
//                    .andExpect(status().isOk())
...
//            lenient().when(bucketService.getItemsByUserId(USER_ID))
//                    .thenThrow(new NotFoundException("Bu user üçün bucket tapılmadı, userId: " + USER_ID));
//
//            mockMvc.perform(get("/buckets/items").param("userId", String.valueOf(USER_ID)))
//                    .andExpect(status().isNotFound());
...
//            lenient().when(bucketService.getItemsByUserId(USER_ID)).thenReturn(List.of(itemResponse, resp2));
//
//            mockMvc.perform(get("/buckets/items").param("userId", String.valueOf(USER_ID)))
//                    .andExpect(status().isOk())
